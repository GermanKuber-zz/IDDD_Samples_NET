...
using SaaSOvation.AgilePM.Domain.Model.Products.BacklogItems.DomainEvents;
...
namespace SaaSOvation.AgilePM.Domain.Model.Products.BacklogItems.BacklogItem
{
    public class BacklogItem : EntityWithCompositeId
    {
        ...
        public Task.Task GetTask(TaskId taskId)
        {
            return _tasks.FirstOrDefault(x => x.TaskId.Equals(taskId));
        }

        private Task.Task LoadTask(TaskId taskId)
        {
